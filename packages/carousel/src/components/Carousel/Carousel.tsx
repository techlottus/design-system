...
const Carousel: React.FC<CarouselType> = (props: CarouselType) => {
  ...
  return (
    <section className="flex flex-col relative w-full my-6">
      <section className="desktop:w-11/12 tablet:w-11/12 mobile:w-full mx-auto">
      ...
      {loaded && instanceRef.current && (
        <>
          <div
            className={cn(
              "z-20 left-0 top-[35%]  tablet:block hidden cursor-pointer",
              stylesBaseControls
            )}
          >
            <span
          ...
          <div
            className={cn(
              "z-20 right-0  top-[35%] tablet:block hidden cursor-pointer",
              stylesBaseControls
            )}
          >
            <span
