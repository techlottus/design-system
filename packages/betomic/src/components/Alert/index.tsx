    ...
    !closed ? <div role="alert" style={style} className={cn(
      ...
      <div className="px-4 py-3">
        <div className="flex items-start lg:items-center">
          ...
          {closable ? (
            <div className="ml-3 lg:ml-5 flex-shrink-0 flex">
              <button
                ...
                <svg className="h-4 w-4 lg:h-6 lg:w-6" aria-hidden="true" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M51.121 17.121a3 3 0 1 0-4.242-4.242L32 27.757 17.121 12.88a3 3 0 1 0-4.242 4.242L27.757 32 12.88 46.879a3 3 0 1 0 4.242 4.242L32 36.243 46.879 51.12a3 3 0 1 0 4.242-4.242L36.243 32 51.12 17.121Z" fill="currentColor"/></svg>
              </button>
            </div>
          ) : null }
        </div>
