...
Dropdown options can be nested using dropdown inside the item as shown below:
...
{    <DropDown >
    ...
    <DropDown.Items className="h-40">
      <DropDown.Item >
        <DropDown>
          <DropDown.Button className="z-10">Option Nested</DropDown.Button>
          <DropDown.Items className="left-52 mt-0 shadow z-10">
            <DropDown.Item>option 1</DropDown.Item>
            <DropDown.Item>option 2</DropDown.Item>
          </DropDown.Items>
        </DropDown>
