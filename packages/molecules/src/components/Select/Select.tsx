  ...
  return (
    ...
    placeholder={placeholder}
     ...
     ["text-surface-200 cursor-none"]:disabled && !error},className)}>
      ...
      <div className={cn('py-1.5 px-2 align-middle cursor-text  overflow-hidden truncate group-focus:flex hidden',{["text-error-500"]:error})}>label</div>
      <div className={cn('py-1.5 px-2 align-middle cursor-text  overflow-hidden truncate group-focus:hidden',{["text-error-500"]:error})}>{children}</div>
