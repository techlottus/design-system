...
const Button = (props:ButtonType) =>{
  ...
  return (
    <Listbox.Button placeholder={placeholder} className={cn("border border-surface-300 rounded flex focus:border-surface-500",className)}><div className='py-2.5 px-2'>{children}</div><span className='order-last font-icons-solid text-lg text-center p-2 rounded-s-none rounded-e bg-surface-300 focus:border-surface-500'>expand_more</span></Listbox.Button>
  )
}
