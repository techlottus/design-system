...
import { FormGroup, InputGroup } from '@bedu-tmp/betomic';
...
import { InputGroup, FormGroup } from '@bedu-tmp/betomic';
...
<table className="min-w-full divide-y divide-gray-200">
  ...
  <tbody className="divide-y divide-gray-200">
    ...
    <tr>
      ...
      <td className="border-l-0 border-r-0 px-6 py-4 text-sm font-medium text-gray-500">
        `boolean` = *"false"* <span className="block">Styles when actions are not available</span>
      </td>
    </tr>
    <tr>
      <td className="border-l-0 border-r-0 px-6 py-4 text-sm font-medium text-gray-500">
    ...
    <tr>
      ...
      <td className="border-l-0 border-r-0 px-6 py-4 text-sm font-medium text-gray-500">
        `boolean` = *"false"* <span className="block">A `*` decoration</span>
      </td>
    </tr>
    <tr>
      <td className="border-l-0 border-r-0 px-6 py-4 text-sm font-medium text-gray-500">
...
<table className="min-w-full divide-y divide-gray-200">
  ...
  <tbody className="divide-y divide-gray-200">
    ...
    <tr>
      ...
      <td className="border-l-0 border-r-0 px-6 py-4 text-sm font-medium text-gray-500">
        `boolean` = *"true"* <span className="block">When to display a form group message</span>
      </td>
    </tr>
    <tr>
      <td className="border-l-0 border-r-0 px-6 py-4 text-sm font-medium text-gray-500">
      ...
      <td className="border-l-0 border-r-0 px-6 py-4 text-sm font-medium text-gray-500">
        `"error" | "warning" | "success" | "default" | "info"` = *"default"* <span className="block">Message box styles</span>
      </td>
    </tr>
    <tr>
      <td className="border-l-0 border-r-0 px-6 py-4 text-sm font-medium text-gray-500">
