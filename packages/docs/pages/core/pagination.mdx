...
<Pagination align="center" totalRecords={200} />

## Alignment

By default, the `<Pagination />` is displayed to the right side of the page row, following the most common design practices for paginations. Nonetheless, through the prop `align`, which is optional, and receives three possible string values "left", "center", or "right" the position of the component can be adjusted accordingly.

<Pagination align="left" totalRecords={200} />

<Pagination align="center" totalRecords={200} />

<Pagination align="right" totalRecords={200} />

```jsx highlight=15,21,28
import { Pagination } from "@exponentialeducation/betomic";
...
<Pagination align="center" totalRecords={250} defaultPage={5} />

If the `defaultPage` value is greater than the pagination `totalPages` value, `defaultPage` will be set to 1.

<Pagination align="center" totalRecords={250} defaultPage={10} />
...
<Pagination align="center" pageLimit={5} totalRecords={5} />
...
<Pagination align="center" pageLimit={1} totalRecords={23} defaultPage={3} />

#### pageNeighbours = 1

<Pagination align="center" pageLimit={1} pageNeighbours={1} totalRecords={23} defaultPage={4} />

#### pageNeighbours = 2

<Pagination align="center" pageLimit={1} pageNeighbours={2} totalRecords={23} defaultPage={5} />
...
<table className="min-w-full divide-y divide-gray-200">
  ...
  <tbody className="divide-y divide-gray-200">
    <tr>
      ...
      <td className="border-l-0 border-r-0 px-6 py-4 text-sm font-medium text-gray-500">
        **"left" | "center" | "right"** *= "right"*<br/>
        Whether the pagination component should be displayed to the left, center, or right side of the page row.<br/>
      </td>
    </tr>
