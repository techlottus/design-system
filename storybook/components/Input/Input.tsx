...
const Input: InputGroupType = (props: InputGroupType) => {
  ...
  const containerClasses = cn("flex border rounded h-10 input-group grow align-middle",{["border-b border-x-0 border-t-0 bg-surface-100 rounded-b-none"]:variant==="flat"},
