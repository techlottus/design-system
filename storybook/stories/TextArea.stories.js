...
const ErrorExample = (args) => (
  ...
  <div className="flex justify-between"><span className="font-text text-error-500 animate-ping">Error text help</span> <span className="font-text text-surface-400">0/100</span></div>
</div>
);
