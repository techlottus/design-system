...
const TextFieldExample = (args) => (
  ...
  <div className="flex justify-between text-sm"><span className="font-text text-surface-500">Text help</span> <span className="font-text text-surface-400">0/100</span></div>
</div>
);
