...
const Template = () =>{ 
  ...
  return(
    <Accordion>
    <Accordion.Button open={open} onClick={()=>{open? setOpen(false): setOpen(true)}} className={cn("p-4 flex border-surface-200 w-full ",{["rounded-lg border"]:!open, ["rounded-t-lg border-t border-x bg-surface-200"]:open})} >
      Button
    </Accordion.Button>
