...
<div className="w-full flex space-x-2">
  ...
  </ Input><button type="submit" className="p-2 bg-surface-300" onClick={handleSubmit}>submit</button>  
  <span className="my-3 p-3 bg-primary-400 text-lg font-texts w-full flex justify-center"> Hi , {name}</span></div>
