...
export default {
 safelist: ["font-headings","font-texts","font-icons-outlined","font-icons-solid","font-icons","bg-logo","bg-favicon"], theme: {
 extend:  {
  "colors": {
    "primary": {
      "0": "var(--primary-0)",
  ...
  "fontFamily": {
    ...
    "texts": "var(--texts)",
    "icons-outlined": "var(--icons-outlined)",
    "icons-solid": "var(--icons-solid)",
    "icons": "var(--icons)"
  },
  "backgroundImage": {
    "logo": "var(--logo)",
